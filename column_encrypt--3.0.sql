/* share/extension/column_encrypt--3.0.sql */
...
DROP OPERATOR CLASS IF EXISTS public.btree_text_enc_ops USING btree;
DROP OPERATOR FAMILY IF EXISTS public.btree_text_enc_ops USING btree;
DROP OPERATOR CLASS IF EXISTS public.btree_bytea_enc_ops USING btree;
DROP OPERATOR FAMILY IF EXISTS public.btree_bytea_enc_ops USING btree;
...
DROP FUNCTION IF EXISTS public.enc_gt_enctext(encrypted_text, encrypted_text);
DROP FUNCTION IF EXISTS public.enc_ge_enctext(encrypted_text, encrypted_text);
DROP FUNCTION IF EXISTS public.enc_le_enctext(encrypted_text, encrypted_text);
DROP FUNCTION IF EXISTS public.enc_lt_enctext(encrypted_text, encrypted_text);
DROP FUNCTION IF EXISTS public.enc_gt_encbytea(encrypted_bytea, encrypted_bytea);
DROP FUNCTION IF EXISTS public.enc_ge_encbytea(encrypted_bytea, encrypted_bytea);
DROP FUNCTION IF EXISTS public.enc_le_encbytea(encrypted_bytea, encrypted_bytea);
DROP FUNCTION IF EXISTS public.enc_lt_encbytea(encrypted_bytea, encrypted_bytea);
DROP FUNCTION IF EXISTS public.enc_cmp_enctext(encrypted_text, encrypted_text);
DROP FUNCTION IF EXISTS public.enc_cmp_encbytea(encrypted_bytea, encrypted_bytea);
